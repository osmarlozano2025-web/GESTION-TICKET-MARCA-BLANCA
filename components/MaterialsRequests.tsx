              ...
              <tbody className="divide-y divide-white/5">
                {requests.map((req) => (
                  <tr key={req.id} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="px-6 py-5">
                      <span className={`px-2.5 py-1 rounded-full text-[9px] font-black uppercase border ${req.status === 'Pendiente' ? 'bg-orange-500/10 text-orange-500 border-orange-500/20' :
          ...
          <div className="bg-white text-slate-900 w-full max-w-3xl rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(242,162,13,0.3)] flex flex-col">
            <div className="bg-slate-900 text-white p-8 flex justify-between items-center shrink-0">
              <div className="flex items-center gap-4">
                <div className="bg-primary size-12 flex items-center justify-center rounded-xl text-black font-black">ID</div>
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tighter">Vale de <span className="text-primary">Materiales</span></h3>
                  <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Impulso Digital • Central Logistics</p>
                </div>
              </div>
